    ...
    <main className="max-w-4xl mx-auto p-8 font-sans text-gray-900">
      <header className="mb-8">
        ...
        <p className="mt-3 text-lg text-gray-700 max-w-prose">
          ...
          website or services. By accessing or using our platform, you agree to
      ...
      <section className="space-y-8 text-gray-800 leading-relaxed text-base">
        <article>
          ...
          <p>
            ...
            and in accordance with these terms. Unauthorized use or violation of
        ...
        <article>
          ...
          <p>
            ...
            website are owned by us or licensed to us. You may not use,
            reproduce, or distribute any materials without explicit permission.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            to use our website or services, including indirect, incidental, or
        ...
        <article>
          ...
          <p>
            ...
            shall be subject to the exclusive jurisdiction of Nepali courts.
          </p>
        </article>
      </section>
    </main>
